...
- create the matching page in `writing/`
- set it to `published` or `queued`
- render the uploaded markdown file directly so the story stays intact
- only fall back to manual section cards when no source document is attached
